    ...
    <tr>
		...
		<form action="process_bayadcheck.php" method="POST">
            <table  >
				...
				<td>
				<input type="text" border="none"  name="checknum" style="width: 200px" onkeyup="sum();" >
				</td>
				</tr>
				...
				<td>
				<input type="text" border="none"  name="bankname" style="width: 200px" onkeyup="sum();" >
				</td>
				</tr>
				...
				<td>
				<input type="text" border="none"  name="checkamount" style="width: 200px" onkeyup="sum();" >
				</td>
				</tr>
